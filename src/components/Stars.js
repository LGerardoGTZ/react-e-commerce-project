...
const  Stars = ({ stars, reviews }) => {
  const tempStars = Array.from({ length: 5 }, (_, index) => {//remember, the second argument in Array.from is a callback function!!
    //index go from 0 to 4 in this case
    const number = index + 0.5 //this constant replaces the hardcoded sequence of numbers with the previous approach
    return (
      <span key={index}>
 ...
 * 
 * 
 * Manual approach for the raiting stars
 * 
 *    ** star **
